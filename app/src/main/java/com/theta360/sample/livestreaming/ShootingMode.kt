...
enum class ShootingMode(
    ...
    RIC_MOVIE_PREVIEW_640("RicMoviePreview640", 640, 320, "640x320", true),
    RIC_MOVIE_PREVIEW_1024("RicMoviePreview1024", 1024, 512, "1024x512", true),
    RIC_MOVIE_PREVIEW_1920("RicMoviePreview1920", 1920, 960, "1920x960", true),
