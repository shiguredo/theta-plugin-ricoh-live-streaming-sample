...
public class ThetaHardwareVideoEncoderFactory implements VideoEncoderFactory {
  private static final String TAG = "ThetaHardwareVideoEncoderFactory";
   ...
   */
  public ThetaHardwareVideoEncoderFactory(
   ...
   */
  public ThetaHardwareVideoEncoderFactory(EglBase.Context sharedContext, boolean enableIntelVp8Encoder,
  ...
  @Deprecated
  public ThetaHardwareVideoEncoderFactory(boolean enableIntelVp8Encoder, boolean enableH264HighProfile) {
  ...
  public VideoEncoder createEncoder(VideoCodecInfo input) {
    ...
    return new ThetaHardwareVideoEncoder(new MediaCodecWrapperFactoryImpl(), codecName, type,
